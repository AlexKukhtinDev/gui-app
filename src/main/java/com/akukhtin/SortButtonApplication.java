...
public class SortButtonApplication extends JFrame {
  ...
  public SortButtonApplication() {
    insets = new Insets(DEFAULT_INDENT, DEFAULT_INDENT, 0, DEFAULT_INDENT);
    new IntroScreen(this);
  }

  public static void main(String[] args) {
    new SortButtonApplication();
  }

  public class IntroScreen {
    private static final String
            WRONG_INPUT_MESSAGE = "The input must be number more than 0 and less than 300";
    ...
    private void setGridBagConstraints(GridBagConstraints gridBagConstraints) {
  ...
  public class SortScreen {
    ...
    private static final String
            WRONG_QUANTITY_MESSAGE = "The number must be in the range from 1 to 30";
    ...
    private void addFuncButtons(GridBagConstraints gridBagConstraints, JFrame frame) {
      setGridXY(gridBagConstraints);
      addToFrame(gridBagConstraints, frame);
    }

    private void addToFrame(GridBagConstraints gridBagConstraints, JFrame frame) {
    ...
    private void setGridXY(GridBagConstraints gridBagConstraints) {
    ...
    private void addNumberButtons(GridBagConstraints gridBagConstraints, int buttonQuantity,
      ...
      setWeightAndGridX(gridBagConstraints);
    ...
    private void setWeightAndGridX(GridBagConstraints gridBagConstraints) {
    ...
    private List<Integer> addListOfNumbers(int buttonQuantity) {
      ...
      return getIntegersArray(buttonQuantity, random, requiredNum);
    }

    private List<Integer> getIntegersArray(int buttonQuantity, Random random, int requiredNum) {
    ...
    private ActionListener getSortListener(JFrame frame) {
      return e -> {
        boolean ascendingOrder =
                Comparators.isInOrder(listOfNumbers, Comparator.naturalOrder());
  ...
  private JButton getJButton(String name, Color color, ActionListener actionListener) {
    setOptionButton(name, color, actionListener);
    return button;
  }

  private void setOptionButton(String name, Color color, ActionListener actionListener) {
  ...
  public class QuickSort implements Runnable {
    ...
    private void repaintAfterSort(Integer[] array) {
      treadSleep();
      frame.getContentPane().removeAll();
